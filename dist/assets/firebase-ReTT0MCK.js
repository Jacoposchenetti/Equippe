 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const of="storage";function Rw(n,e,t){return n=Y(n),ew(n,e,t)}function Sw(n,e,t){return n=Y(n),tw(n,e,t)}function Pw(n){return n=Y(n),nw(n)}function bw(n,e){return n=Y(n),ow(n,e)}function Cw(n=Do(),e){n=Y(n);const r=zs(n,of).getImmediate({identifier:e}),s=ml("storage");return s&&cw(r,...s),r}function cw(n,e,t,r={}){aw(n,e,t,r)}function uw(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new Pa(t,r,s,e,cn)}function lw(){en(new Vt(of,uw,"PUBLIC").setMultipleInstances(!0)),Ge(ul,ll,""),Ge(ul,ll,"esm2020")}lw();export{BT as A,FT as B,Vt as C,KT as D,Sr as E,et as F,HT as G,pw as H,bw as I,Rw as J,Pw as K,zT as L,$T as M,YT as N,WT as O,XT as P,Sw as Q,QT as R,Aw as S,ee as T,en as _,ww as a,bT as b,Cw as c,Iw as d,mw as e,_w as f,fw as g,gw as h,lm as i,jT as j,Sd as k,zs as l,bp as m,dw as n,Ew as o,Do as p,Y as q,Ge as r,Tw as s,rp as t,yw as u,sp as v,hw as w,PT as x,GT as y,UT as z};
//# sourceMappingURL=firebase-ReTT0MCK.js.map
