      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
          <div className="bg-white rounded-xl shadow-sm p-6 sm:p-8 text-center">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Creazione referral non disponibile</h2>
            ...
            <button
              ...
              className="mt-6 w-full sm:w-auto px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
            >
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm p-4 sm:p-6 lg:p-8 space-y-6">
          {/* Filtri di Ricerca */}
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              {[
                ...
                <button
                  ...
                  className={`flex-1 py-2 sm:py-3 rounded-lg border-2 font-semibold text-sm sm:text-base ${
              ...
              <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg text-sm text-blue-800">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    prima dell'invio, in conformità con il GDPR. Solo il professionista destinatario potrà 
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-6">
            <button
              type="submit"
              disabled={loading}
              className="w-full sm:flex-1 bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 disabled:bg-gray-400 font-semibold text-base"
            >
